  ...
  species: Species[] = [
    {
      ...
      image: SavanaImages.leao,
      imageBig: SavanaImages.leaoBig,
    ...
    },
    {
      ...
      emoji: '🦒', native: true, endemic: false,
      image: SavanaImages.girafa,
      imageBig: SavanaImages.girafaBig,
      ...
      ecology: 'Dispersora de sementes de acrescerá. Ao podar os galhos altos, favorece a estrutura das árvores e cria nichos para outras espécies.'
    },
    {
      type: 'fauna', name: 'Elefante-africano', scientific: 'Loxodonta africana',
      emoji: '🐘', native: true, endemic: false,
      image: SavanaImages.elefante,
      imageBig: SavanaImages.elefanteBig,
    ...
    },
    {
      ...
      image: SavanaImages.loboGuara,
      imageBig: SavanaImages.loboGuaraBig,
    ...
    },
    {
      ...
      emoji: '🐃', native: true, endemic: false,
      image: SavanaImages.gnu,
      imageBig: SavanaImages.gnuBig,
    ...
    },
    {
      ...
      emoji: '🌳', native: true, endemic: false,
      image: SavanaImages.acacia,
      imageBig: SavanaImages.acaciaBig,
    ...
    },
    {
      ...
      emoji: '🌴', native: true, endemic: false,
      image: SavanaImages.baoba,
      imageBig: SavanaImages.baobaBig,
    ...
    },
    {
      ...
      emoji: '🌰', native: true, endemic: true,
      image: SavanaImages.pequizeiro,
      imageBig: SavanaImages.pequizeiroBig,
    ...
    },
    {
      ...
      emoji: '🌾', native: true, endemic: false,
      image: SavanaImages.capim,
      imageBig: SavanaImages.capimBig,
      adaptation: 'Crescimento rápido após as chuvas (até 4cm/dia). Raízes profundas e extensas que estabilizam o solo e sobrevivem à queimada para rebrotar in dias.',
    ...
    },
    {
      ...
      emoji: '🌴', native: true, endemic: false,
      image: SavanaImages.buriti,
      imageBig: SavanaImages.buritiBig,
